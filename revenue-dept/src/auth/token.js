 ...
 * 1. Exactly 3 dot-separated base64url parts.
 * 2. Header parsing and strict alg === 'HS256' + typ === 'JWT' enforcement.
 * 3. Constant-time cryptographic HMAC verification against server secret.
 * 4. Payload parsing and mandatory claim validation (sub, role, dept, jti, iat, exp).
 * 5. Expiration validation (with 60s clock skew tolerance).
 * 6. JTI revocation check against revocation store.
 * 
